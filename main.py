...
def get_args():
    ...
    parser.add_argument('--stats_dir', type=str, default='./results/stats')
    parser.add_argument('--photo_path', type=str, default='./images/photo_jpg')
    parser.add_argument('--monet_path', type=str, default='./images/monet_jpg')
